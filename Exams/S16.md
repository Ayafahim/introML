...
## 23) Consider the 1-dimensional data set comprised of N = 10 observations shown in Table 7. Which one of the following clusterings corresponds to a converged state of a K-means algorithm using standard Euclidian distances?
