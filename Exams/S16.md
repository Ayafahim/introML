...
## A hierarchical clustering is applied to the 9 observations in Table 2 using minimum linkage.  Which of the dendrograms shown in Figure 4 corresponds to the clustering?
